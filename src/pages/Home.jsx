...
const Home = () => {
  ...
  return (
      <div className='relative pt-24 min-h-[100vh]  h-full w-full justify-center align-middle    text-white flex px-[20px]  sm:px-10  lg:px-[50px] xl:px-[100px] '>
           <>
        ...
        <div className='lg:w-[50%] w-full h-full min-h-[85vh]  flex-col flex gap-4 sm:pb-0 lg:pb-[15vh]'>
                <div className='lg:text-[40px] 2xl:text-[50px] text-[27px] sm:text-[48px] font-extrabold flex space-x-2'>
                  ...
                  <div className='sm:flex sm:flex-row flex-col space-y-5 sm:space-y-0 w-full gap-5 mt-6 md:mb-12 xl:mb-0 sm:mb-12   '>
               ...
               <div className='relative w-[50%] lg:flex hidden lg:visible'>
                  ...
                  <img className='absolute right-9 bottom-0  w-[60%] h-full md:w-[72%] lg:w-[63%] xl:w-[65%]' src={armsfolded} alt='image' />
